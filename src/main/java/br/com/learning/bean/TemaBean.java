...
public class TemaBean implements Serializable {
	...
	public String[] getTemas(){
		...
		return new String[] {"afterdark", "afternoon", "afterwork", "aristo", 
				...
				"cupertino", "ruze", "dark-hive", "delta", "dot-luv, eggplant", 
				"excite-bike", "flick", "glass-x", "home", "hot-sneaks", "humanity", 
				"le-frog", "midnight", "mint-choc", "omega", "overcast", "pepper-grinder", 
